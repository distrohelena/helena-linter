...
func TestAnalyzer(t *testing.T) {
	analysistest.Run(t, mustAbs(t, filepath.Join("..", "..", "testdata")), Analyzer, "redundantelseif")
}
...
func f(value any) {
	if value == nil {
		println("nil")
	} else /* keep this */ if value != nil /* and this */ {
		println("not nil")
	}
}
`
...
func TestSuggestedFixRewritesPlainElseIf(t *testing.T) {
	const src = `package p
