...
/**
 * Enforces spacing before declaration statements when they follow non-declarations.
 */
export const declarationLeadingSpacingRule = createRule({
    name: "declaration-leading-spacing",
    meta: {
        type: "layout",
        fixable: "whitespace",
        docs: {
            description:
                "Require a blank line before a declaration statement when the previous sibling is not a declaration.",
        },
        messages: {
            declarationLeadingSpacing:
                "Insert a blank line before this declaration statement.",
        },
        schema: [],
    },
    defaultOptions: [],
    create(context) {
        return {
            Program(): void {
                ...
                /**
                 * Inspects sibling statements for missing blank lines before declarations.
                ...
                function inspectStatements(
                    ...
                    for (let index = 1; index < statements.length; index += 1) {
                        ...
                        if (
                            ...
                            ts.isVariableStatement(previousStatement)
                        ) {
                            continue;
                        }
                        ...
                        context.report({
                            ...
                            messageId: "declarationLeadingSpacing",
                            fix(fixer) {
